  ...
  return (
    <div>
      ...
      >
        ...
        >
          <div
            className="overflow-hidden rounded-lg relative h-full"
            ref={imageRef}
          >
            ...
            {imageLoaded && !imageError && (
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent transition-opacity duration-300 ease-out "></div>
            )}
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 z-10">
                <div className="flex flex-col-reverse md:flex-row md:justify-between md:items-end">
                  <div className="flex-1">
                    <span className="text-sm text-white/80 glor-l block">
                      {makesubcategoryAsName}
                    </span>
                    <h3
                      className={cn(
                        "text-xl md:text-2xl font-semibold text-white mt-1 capitalize",
                        unbounded.className
                      )}
                    >
                      {makeTtitleAsTitle}
                  ...
                  <div className="mb-2 md:mb-0">
                    <span className="text-sm text-white/70 glor-l">{date}</span>
                  </div>
                </div>
              </div>
            )}
            ...
            {imageLoaded &&
              ...
              !isMobile && ( // Hide view text on mobile
                <div
                  ref={viewTextRef}
                  className={cn(
                    "rounded-full absolute top-0 left-0 bg-white/20 backdrop-blur-sm text-white hidden display:block footer-up-button font-semibold px-4 py-2 text-lg pointer-events-none navbarmain md:flex items-center gap-x-2 willchange uppercase z-20",
                    unbounded.className
                  )}
                >
...
//                   <div>
//                     <span className="text-sm dark:text-gray-300 glor-l">
//                       {makesubcategoryAsName}
//                     </span>
//                     <h3
//                       className={cn(
